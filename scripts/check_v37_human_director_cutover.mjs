...
const wrappedV40 = wrangler.includes('"main": "src/index_v40_scene_continuity.js"')
  ...
  && v39Entrypoint.includes('from "./index_v38_quality_guard.js"')
  && v38Entrypoint.includes('from "./index_v37_lively_ambient.js"');
assert.ok(directV37 || wrappedV38 || wrappedV39 || wrappedV39Presence || wrappedV39World || wrappedV40, "production entrypoint must retain human Director through an explicit v37/v38/v39/v40 wrapper chain");
