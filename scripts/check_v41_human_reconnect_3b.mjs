...
assert.ok(reconnectWrapper.includes('from "./index_v37.js"'));
assert.ok(!reconnectWrapper.includes('from "./index_v38_quality_guard.js"'));
assert.ok(reconnectWrapper.includes("V37ChatRoom.prototype.system.call"));
assert.ok(reconnectWrapper.includes("V37ChatRoom.prototype.webSocketClose.call"));
