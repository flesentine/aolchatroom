...
assert.ok(wrapper.includes("V37ChatRoom.prototype.lineViolation.call"));
assert.ok(wrapper.includes("V37ChatRoom.prototype.noteViolation.call"));
assert.ok(wrapper.includes("V37ChatRoom.prototype.historicalAudit.call"));
