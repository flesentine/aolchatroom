...
assert.ok(reconnectWrapper.includes('from "./index_v37_free_providers.js"'));
assert.ok(!reconnectWrapper.includes('from "./index_v38_quality_guard.js"'));
assert.ok(reconnectWrapper.includes("V37FreeProviderChatRoom.prototype.system.call"));
assert.ok(reconnectWrapper.includes("V37FreeProviderChatRoom.prototype.webSocketClose.call"));
