...
assert.ok(v41ProviderFailoverCompat.includes('from "./index_v41_hotfix_residual_compat.js"'), "3G.9 failover owner must sit above the final hotfix residual");
assert.ok(v41HotfixResidualCompat.includes('from "./index_v37.js"'), "3G.9 residual hotfix owner must preserve the frozen v37 baseline");
