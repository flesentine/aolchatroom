...
const v41HumanDirectorCompatRuntime = fs.readFileSync(new URL("../src/index_v41_human_director_compat.js", import.meta.url), "utf8");
...
const v41PublicFactRuntime = fs.readFileSync(new URL("../src/index_v41_public_fact_grounding.js", import.meta.url), "utf8");
const v41PublicFactHardenedRuntime = fs.readFileSync(new URL("../src/index_v41_public_fact_grounding_hardened.js", import.meta.url), "utf8");
const v41GenerationRoot = wrangler.includes('"main": "src/index_v41_generation_contract.js"')
  || (
    ...
    && v41PublicFactHardenedRuntime.includes('from "./index_v41_public_fact_grounding.js"')
    && v41PublicFactRuntime.includes('from "./index_v41_generation_contract.js"')
  );
