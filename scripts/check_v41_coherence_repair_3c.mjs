...
assert.ok(wrapper.includes("V37HotfixChatRoom.prototype.resolveDirectTarget.call"));
assert.ok(wrapper.includes("V37HotfixChatRoom.prototype.voiceBrainPlan.call"));
