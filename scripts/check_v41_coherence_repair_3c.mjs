...
assert.ok(wrapper.includes("V37HumanOnlyChatRoom.prototype.resolveDirectTarget.call"));
assert.ok(wrapper.includes("V37HumanOnlyChatRoom.prototype.voiceBrainPlan.call"));
