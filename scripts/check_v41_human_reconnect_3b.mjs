...
assert.ok(reconnectWrapper.includes('from "./index_v37_human_director.js"'));
assert.ok(!reconnectWrapper.includes('from "./index_v38_quality_guard.js"'));
assert.ok(reconnectWrapper.includes("V37HumanDirectorChatRoom.prototype.system.call"));
assert.ok(reconnectWrapper.includes("V37HumanDirectorChatRoom.prototype.webSocketClose.call"));
