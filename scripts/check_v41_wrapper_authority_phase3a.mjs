...
const v41LegacyHumanOnlyDiagnostics = read("src/human_only_legacy_diagnostics_v41.js");
...
console.log("v41 Phase 3A remaining-wrapper authority characterization passed after 3G.17 residual retirement");
