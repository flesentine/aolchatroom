...
assert.ok(v41HumanOnlyCompat.includes('from "./index_v41_production_turn_compat.js"'), "3G.7 human-only compatibility must route through the v41 production-turn owner");
assert.ok(v41ProductionTurnCompat.includes('from "./index_v41_hotfix_residual_compat.js"'), "3G.7 production-turn authority must sit above the residual hotfix owner");
assert.ok(v41HotfixResidualCompat.includes('from "./index_v37.js"'), "3G.7 residual hotfix owner must preserve the frozen v37 baseline");
