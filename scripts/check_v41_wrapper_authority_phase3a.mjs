...
assert.ok(v41ProviderReadinessCompat.includes('from "./index_v41_hotfix_residual_compat.js"'), "3G.8 readiness owner must sit above the residual hotfix owner");
assert.ok(v41HotfixResidualCompat.includes('from "./index_v37.js"'), "3G.8 residual hotfix owner must preserve the frozen v37 baseline");
