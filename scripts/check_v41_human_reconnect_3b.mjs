...
assert.ok(reconnectWrapper.includes('from "./index_v37_lively_ambient.js"'));
assert.ok(!reconnectWrapper.includes('from "./index_v38_quality_guard.js"'));
assert.ok(reconnectWrapper.includes("V37LivelyChatRoom.prototype.system.call"));
assert.ok(reconnectWrapper.includes("V37LivelyChatRoom.prototype.webSocketClose.call"));
