...
assert.ok(v41OutputHygieneCompat.includes('from "./index_v41_hotfix_residual_compat.js"'), "3G.10 output-hygiene owner must sit above the final hotfix residual");
assert.ok(v41HotfixResidualCompat.includes('from "./index_v37.js"'), "3G.10 residual hotfix owner must preserve the frozen v37 baseline");
