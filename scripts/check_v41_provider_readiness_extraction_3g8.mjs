...
assert.ok(readiness.includes('from "./index_v41_hotfix_residual_compat.js"'));
...
for (const marker of [
  ...
  assert.ok(residual.includes(marker), `3G.8 must leave later residual authority untouched: ${marker}`);
}
